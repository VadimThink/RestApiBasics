...
class GiftCertificateDaoImplTest {
    ...
    private static final GiftCertificate CERTIFICATE_TO_CREATE = new GiftCertificate(
            4L, "certificate new", "description new", new BigDecimal("1.10"), 1,
            LocalDateTime.parse("2020-01-01T01:11:11").atZone(ZoneId.of("GMT+3")),
            LocalDateTime.parse("2021-01-01T01:22:11").atZone(ZoneId.of("GMT+3")));
    ...
    private static final GiftCertificate SECOND_CERTIFICATE = new GiftCertificate(
            ...
            LocalDateTime.parse("2021-02-02T02:33:22").atZone(ZoneId.of("GMT+3")));
    private static final GiftCertificate THIRD_CERTIFICATE = new GiftCertificate(
            ...
            LocalDateTime.parse("2021-03-03T03:44:33").atZone(ZoneId.of("GMT+3")));
    @Autowired
    ...
    public void testGetAllWithSortingShouldGet() {
        //given
        SortingParameters sortParamsContext = new SortingParameters(
                Collections.singletonList("id"), Collections.singletonList("DESC"));
        //when
        List<GiftCertificate> giftCertificates = certificateDao.getWithSorting(sortParamsContext);
        //then
    ...
    public void testGetAllWithFilteringShouldGet() {
        //given
        //when
        List<GiftCertificate> giftCertificates = certificateDao.getWithFiltering(
    ...
    public void testGetAllWithSortingFilteringShouldGet() {
        ...
        SortingParameters sortParamsContext = new SortingParameters(
                Collections.singletonList("id"), Collections.singletonList("DESC"));
        //when
        List<GiftCertificate> giftCertificates = certificateDao.getWithSortingAndFiltering(
    ...
    public void testUpdateByIdShouldUpdate() {
        //when
        certificateDao.updateById(FIRST_CERTIFICATE.getId(),FIRST_CERTIFICATE, false);
        Optional<GiftCertificate> giftCertificate = certificateDao.findById(
                FIRST_CERTIFICATE.getId());
        //then
